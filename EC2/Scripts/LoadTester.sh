set -e
   ...
   # O systemd pode carregar as variáveis diretamente do arquivo .env
   # usando a diretiva 'EnvironmentFile'. Isso é mais limpo e seguro.
   ...
   # AQUI ESTÁ A MÁGICA: O systemd carrega o arquivo .env antes de rodar o comando.
